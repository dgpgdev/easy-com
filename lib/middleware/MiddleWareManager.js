...
var MiddleWareManager = function () {
  ...
  * */
   ...
   */
		...
		value: function iterateMiddleWare(iterator, evt, socket, data) {
			var _this = this;

			var it = iterator.next();
			if (!it.done) {
				var next = function next() {
					return _this.iterateMiddleWare.call(_this, iterator, evt, socket, data);
				};
   ...
   */
		...
		value: function executeMiddleware(evt, socket, data) {
